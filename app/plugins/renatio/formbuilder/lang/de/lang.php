...
return [
    ...
    'field' => [
        ...
        'has_multiple_files' => 'Allow multiple files',
        'send_file_as_mail_attachment' => 'Send uploaded files as mail attachments',
        'file_mode' => 'Display mode',
    ...
    'field_type' => [
        ...
        'delete_error' => 'Cannot delete field type, because it is in use. Please delete all form fields that uses this field type first.',
    ],
    'render_form' => [
    ...
    'comment' => [
        ...
        'file_mode' => 'Display mode for files in a form log entry.',
        'is_array_validation' => 'When checked the rule will be applied for each element of an array.',
        'template_code' => 'When mail template is not selected, than the form will not be send via email.',
    ],
    'help' => [
        'duplicate' => 'Duplicate',
        'delete' => 'Delete',
