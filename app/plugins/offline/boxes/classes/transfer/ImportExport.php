...
class ImportExport
{
    ...
    protected function emptyTargetDir(bool $withAttachments): void
    {
        ...
        File::deleteDirectory($this->targetDir . '/' . $this->attachmentsDir);
        File::deleteDirectory($this->targetDir . '/' . $this->pagesDir);
        File::delete($this->targetDir . '/' . $this->structureFileName);
