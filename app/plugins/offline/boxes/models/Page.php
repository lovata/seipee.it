...
class Page extends Model
{
    ...
    use \OFFLINE\Boxes\Classes\Traits\HasMultisiteSupport {
        withoutMultisiteScope as multisiteWithoutMultisiteScope;
    }
    use \OFFLINE\Boxes\Classes\Traits\HasRevisions {
        scopeCurrentPublished as revisionScopeCurrentPublished;
        scopeCurrentDrafts as revisionScopeCurrentDrafts;
        scopeCurrent as revisionScopeCurrent;
    }
